...
const instance = axios.create({ baseURL: 'https://api.themoviedb.org/3/search/movie?include_adult=false&language=en-US&page=1', });
...
const options = {
 ...
 export async function RequestPopularMovies() {
      const response = await instance.get('api.themoviedb.org/3/search/movie?include_adult=false&language=en-US&page=1/',
      );
